...
gem_wrap name do |t|
  t.version       = '1.0.0'
  t.summary       = 'ActionScript 3.0 / Flex framework for unit testing. This is the package without flex components.'
...
- !ruby/object:Sprout::RemoteFileTarget
  platform: universal  
  url: http://flexunit.digitalprimates.net:8080/job/FlexUnit4-Flex3.4-AS3/45/artifact/flexunit-4.0.0.zip
  install_path: '../flexunit-4.0.0.swc'
  archive_path: flexunit/flexunit-4.0.0.swc
EOF
end
