...
post_image_flickr: http://www.flickr.com/photos/usdagov/5187023831/sizes/z/
post_image_author_link: http://www.flickr.com/photos/usdagov/
post_image_author_name: USDAgov
post_image_license: http://creativecommons.org/licenses/by-nd/2.0/
post_image_local: /images/5187023831_8a158e6e0d_z.jpg
post_image_title: Manure Generator
---
...
<a href="{{ page.post_image_flickr }}">Manure Generator Image</a> courtesy of <a href="{{ page.post_image_author_link }}">{{ page.post_image_author_name }}</a> and the <a href="{{ page.post_image_license }}">Creative Commons</a> license.
</span>
