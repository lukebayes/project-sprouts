...
module Sprout::Tool::Task
  ...
  module InstanceMethods
    ...
    def default_file_expression
      @default_file_expression ||= Sprout::Tool::Task::DEFAULT_FILE_EXPRESSION
    end

    ##
    # The default RubyGem that we will use when requesting our executable.
    #
    # Classes that include the Tool::Task can set the default value for this property
