...
require 'lib/sprout/flex3sdk/version'

PROJECT                 = 'sprout'
NAME                    = 'sprout-flex3sdk-tool'
SUMMARY                 = 'Adobe Flex 3 SDK including mxmlc, compc, asdoc and fdb'
GEM_VERSION             = Sprout::Flex3SDK::VERSION::STRING
AUTHOR                  = 'Adobe, Inc.'
EMAIL                   = 'projectsprouts@googlegroups.com'
HOMEPAGE                = 'http://www.adobe.com/products/flex'
DESCRIPTION             = "The Flex 3 SDK Rubygem is brought to you by Project Sprouts (http://www.projectsprouts.org)"
