...
module Sprout
  ...
  class MXMLCTask
    ...
    #
    add_param :accessible, :boolean { |p|
      p.hidden_value = true
    }
    ...
    #
    add_param :allow_source_path_overlap, :boolean { |p|
      p.hidden_value = true
    }
    ...
    #
    add_param :default_size, :string { |p|
      p.delimiter = ' '
    }
    ...
    #
    add_param :define_conditional, :strings { |p|
      p.shell_name = "-define"
    }
    ...
    # This is an advanced option.
    #
    add_param :fonts_languages_language_range, :string { |p|
    ...
    # This is an advanced option.
    # 
    add_param :frames_frame, :string { |p|
    ...
    #
    add_param :show_actionscript_warnings, :boolean { |p|
      p.value = true
      p.show_on_false = true
    }
    ...
    #
    add_param :show_binding_warnings, :boolean { |p|
      p.value = true
      p.show_on_false = true
    }
    ...
    #
    add_param :show_deprecation_warnings, :boolean  { |p|
      p.value = true
      p.show_on_false = true
    }
    ...
    #
    add_param :use_network, :boolean  { |p|
      p.value = true
      p.show_on_false = true
    }
